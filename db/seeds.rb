...
ribeye_16oz = RecipeIngredient.create(name: 'ribeye', category: 'meats', quantity: '16', measurement: 'ounce/ounces', recipe_id: ribeye_steak.id)

salt_1_TBSP = RecipeIngredient.create(name: 'salt', category: 'spices', quantity: '1', measurement: 'tablespoon/tablespoons', recipe_id: ribeye_steak.id)

pepper_1_tsp = RecipeIngredient.create(name: 'pepper', category: 'spices', quantity: '1', measurement: 'teaspoon/teaspoons', recipe_id: ribeye_steak.id)

butter_1_TBSP = RecipeIngredient.create(name: 'butter', category: 'dairy', quantity: '1', measurement: 'tablespoon/tablespoons', recipe_id: ribeye_steak.id)

lime = RecipeIngredient.create(name: 'lime', category: 'produce', quantity: "8", measurement: 'ounce/ounces', recipe_id: brazilian_lemonade.id)
...
sugar_third_cup = RecipeIngredient.create(name: 'sugar', category: 'baking', quantity: '1/3', measurement: 'cup/cups', recipe_id: brazilian_lemonade.id)

water_4_cups = RecipeIngredient.create(name: 'water', category: 'drinks', quantity: '4', measurement: 'cup/cups', recipe_id: brazilian_lemonade.id)


ribeye_16oz = Ingredient.create(name: 'ribeye', category: 'meats', quantity: '16', measurement: 'ounce/ounces', shopping_list_id: monday_night_groceries.id)
