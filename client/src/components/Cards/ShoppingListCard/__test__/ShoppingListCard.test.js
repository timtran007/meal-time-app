...
describe('ShoppingListCard', () => {
    ...
    it('renders Shopping List Card', async () => {
        render(<ShoppingListCard shopping_list={shoppingListProp}/>);
        const heading = await screen.findByText(`${shoppingListProp.name}`)
